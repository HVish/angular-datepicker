...
module.exports = function makeWebpackConfig() {
  let config = {
    ...
    output: {
      path: root('dist'),
      publicPath: isProd ? 'angularx-date-picker' : 'http://localhost:8080/',
    ...
    module: {
      rules: [
        ...
        // all css required in angularx-date-picker files will be merged in js files
        {
          test: /\.(scss|sass)$/,
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        basePath: isProd ? '/angularx-date-picker' : '/',
        angularxDatePickerVersion: require(root('./src/package.json')).version
      }),
